...
const updateUserFunction = (updatedData: any) => {
  console.log('Mise à jour des données :', updatedData);
};
...
export default function Projet() {
  ...
  const filterData = (v: { id: number; titre: string; client: string; dateDebut: string; dateLimite: string; progression: string } | null) => {
    if (v && v.titre) {
